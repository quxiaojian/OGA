...
sub argument{
	...
	if(!exists $options{'indir'}){
		...
		exec ("pod2usage $0");
	}elsif(!exists $options{'thread'}){
		print "***ERROR: No thread is assigned!!!\n";
		exec ("pod2usage $0");
		...
		print "***ERROR: No kmer values are assigned!!!\n";
		exec ("pod2usage $0");
	}elsif(!exists $options{'wordsize'}){
		print "***ERROR: No wordsize value is assigned!!!\n";
		exec ("pod2usage $0");
	}
	return \%options;
}
